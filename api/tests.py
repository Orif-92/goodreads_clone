...
class BookReviewAPITestCase(APITestCase):
    def setUp(self):
        self.user = CustomUser.objects.create(username="orig", first_name="Orig")
    ...
    def test_book_review_detail(self):
        ...
        self.assertEqual(response.data['user']['first_name'], "Orig")
        self.assertEqual(response.data['user']['username'], "orig")
